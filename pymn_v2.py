...
while True:
	...
	elif int(percent_used_storage) in range(81, 100):
		print(colored(f'Used: {used_storage} | {percent_used_storage}% | STORAGE USAGE TOO HIGH', 'red', attrs=['bold', 'blink']))
	...
	elif int(percent_free_storage) in range(81, 100):
		print(colored(f'Free: {free_storage} | {percent_free_storage - 100:.1f}% | NOT ENOUGH SPACE AVAILABLE', 'red', attrs=['bold', 'blink']))
	...
	elif int(percent_used_ram) in range(81, 100):
		print(colored(f'Used: {readable_format(used_ram)} | {percent_used_ram}% | RAM USAGE TOO HIGH', 'red', attrs=['bold', 'blink']))
	...
	elif int(percent_free_ram) in range(81, 100):
		print(colored(f'Free: {free_ram} | {percent_free_ram - 100:.1f}% | NOT ENOUGH RAM AVAILABLE', 'red', attrs=['bold', 'blink']))
	...
	elif int(percent_used_swap) in range(81, 100):
		print(colored(f'Used: {used_swap} | {percent_used_swap}% | SWAP USAGE TOO HIGH', 'red', attrs=['bold', 'blink']))
	...
	elif int(percent_free_swap) in range(81, 100):
		print(colored(f'Free: {free_swap} | {percent_free_swap - 100:.1f}% | SWAP MEMORY TOO LOW!!', 'red', attrs=['bold', 'blink']))
	...
	elif int(cpu_perc) in range(81, 100):
		print(colored(f'Usage: {cpu_perc}% | RAM USAGE TOO HIGH!!', 'red', attrs=['bold']))
